                                ...
                                $.post("${lesson}/admin/deleteUser",
                                    {ids: ids}, function(result){
                                        if(result.exist) {
                                            ...
                                            //$('#dg').datagrid('clearData'); //为什么另一个地方用的了
...
<div id="dlg" class="easyui-dialog"  style="width:500px; height:250px;top:100px; padding:10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            <tr>
                <td>id</td>
                <td> <!-- 原始id 这个属性require会导致注册这里为空,而导致不能提交 -->
            ...
            <td>权限</td>
            <td>
                <select id="roleId" name="roleId" class="easyui-combobox"  style="width:200px;">
            ...
            <tr>
                <td>是否禁止登录</td>
                <td>
                    <select id="block" name="block" class="easyui-combobox"  style="width:200px;">
